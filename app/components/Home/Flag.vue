...
import { ChevronRightIcon, ShieldCheckIcon, ServerStackIcon } from "@heroicons/vue/24/outline";
</script>

<template>
<div
	class="relative w-full h-[50vh] xl:h-[70vh] overflow-hidden"
>
	...
	<div class="absolute inset-0 bg-zinc-500/50 backdrop-blur-sm"></div>

	<div class="absolute inset-0 flex flex-col items-center justify-center">
		<p
			class="text-lg md:text-2xl lg:text-3xl font-semibold text-zinc-800"
		>
